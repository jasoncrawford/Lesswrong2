...
const personalBlogpostInfo = {
  ...
  ProgressForum: {
    name: "Personal Blog",
    tooltip: <div>
      <p><b>Personal Blogposts</b> are posts that don't fit Progress Forum's Frontpage Guidelines. They get less visibility by default. The frontpage guidelines are:</p>
      <ul>
        <li><em>Timelessness</em>. Will people still care about this in 5 years?</li>
        <li><em>Avoid political topics</em>. They're important to discuss sometimes, but we try to avoid it on Progress Forum.</li>
        <li><em>General Appeal</em>. Is this a niche post that only a small fraction of users will care about?</li>
      </ul>
    </div>
  }
